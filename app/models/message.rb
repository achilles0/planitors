class Message < ApplicationRecord
  ...
  def self.deliver_welcome_message(to_user_id)
    ...
    by accepting and completing missions. All For Eco is also the place to look for news, tips and advice related to
    ...
    All For Eco is still in its infancy, as you will surely realize soon. We're very happy you want to take part in
    this journey with us, and develop a platform for a thriving community to enjoy. All For Eco is developed by a
    not-for profit organizaton by the same name.

    Enjoy, and do let us know what you think!
      /Jan Lindblad, All For Eco Community Manager
END
